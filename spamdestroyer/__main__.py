...
MessageEditedRecently = GbanReason.sub(0)
MessageContainsPhoto = GbanReason.sub(0x1)
ImageHashBlackisted = GbanReason.sub(0x2)
MessageTextBlacklisted = GbanReason.sub(0x3)
MessageContainsLink = GbanReason.sub(0x4)
UrlBlacklisted = GbanReason.sub(0x5)
ForwardUserBlacklisted = GbanReason.sub(0x6)
BioTextBlacklisted = GbanReason.sub(0x7)
BioTextEmpty = GbanReason.sub(0x8)
NameTextBlacklisted = GbanReason.sub(0x9)
MessageContainsRtl = GbanReason.sub(0xa)
MessageContainsMention = GbanReason.sub(0xb)
ManuallyBlacklisted = GbanReason.sub(0xc)
AddedGbannedUser = GbanReason.sub(0xd)
